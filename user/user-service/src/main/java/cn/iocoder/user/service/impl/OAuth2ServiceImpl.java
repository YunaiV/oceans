...
import cn.iocoder.user.service.dao.OAuth2AccessTokenMapper;
import cn.iocoder.user.service.dao.OAuth2RefreshTokenMapper;
...
//    }
    ...
    public OAuth2AccessTokenDTO getAccessToken(String mobile, String code) {
        ...
        if (userPO == null) { // 用户不存在
            throw new ServiceException(ErrorCodeConstants.USER_MOBILE_NOT_REGISTERED, "手机号未注册用户"); // TODO 芋艿，处理异常
        }
        // 创建刷新令牌
